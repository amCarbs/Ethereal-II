				...
				if (opcode >= 30 && (opcode ^ 0xffffffff) > -36) {
					...
					if (opcode == 41) {
						...
						for (int i_54_ = 0; (i_54_ ^ 0xffffffff) > (i ^ 0xffffffff); i_54_++) {
							aShortArray880[i_54_] = (short) stream
									.readUnsignedShort();
							aShortArray866[i_54_] = (short) stream
									.readUnsignedShort();
						}
							...
							if ((opcode ^ 0xffffffff) == -99)
								...
								if (opcode == 106 || opcode == 118) {
									...
									if ((opcode ^ 0xffffffff) == -110)
										...
										if (opcode != 113) {
											if (opcode == 114) {
												aByte851 = (byte) (stream
														.readByte());
												aByte854 = (byte) (stream
														.readByte());
											} else if (opcode == 115) {
					...
					for (int i_65_ = 0; (i ^ 0xffffffff) < (i_65_ ^ 0xffffffff); i_65_++) {
						aShortArray896[i_65_] = (short) stream
								.readUnsignedShort();
						aShortArray859[i_65_] = (short) stream
								.readUnsignedShort();
					}
				}
			} else
