...
public class HomeCutScene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actionsList.add(new MovePlayerAction(10, 6, 0, Player.TELE_MOVE_TYPE,
				-1));
		...
		actionsList.add(new NPCForceTalkAction(GUARD1,
				"You must not know, your on Zenith, its da best!", 2));

		actionsList.add(new NPCForceTalkAction(GUARD2,
				"I cant believe he doesnt know!!!!!", 3));
		...
		actionsList.add(new NPCForceTalkAction(GUARD2,
				"He is Definetly a noob.", 2));
		actionsList.add(new NPCForceTalkAction(GUARD2,
				"Its okay, he will come to like this server!", 2));
