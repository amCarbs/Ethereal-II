...
public class Magic {
	...
	public static final void processNormalSpell(Player player, int spellId,
		...
		case 24:
			...
			break;
		case 37: // citadel
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(5888, 4621, 0));
			break;
		case 40: // Minigame/varrock
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(3212, 3429, 0));
			// player.getDialogueManager().startDialogue("TeleportMinigame");
			break;
		case 43: // Training/lumb
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(3223, 3218, 0));
			// player.getDialogueManager().startDialogue("TeleportTraining");
			break;
		case 46: // Boss/fala
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(2964, 3381, 0));
			// player.getDialogueManager().startDialogue("TeleportBosses");
			break;
		case 51: // camelot
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(2757, 3478, 0));
			break;
		case 57: // ardy
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(2664, 3305, 0));
			break;
		case 62: // watch
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(2547, 3113, 2));
			break;
		case 69: // troll
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(2888, 3674, 0));
			break;
		case 72: // ape
			sendNormalTeleportSpell(player, 0, 0, new WorldTile(2804, 2786, 0));
			break;
		}
	}

	private static void useHomeTele(Player player) {
		player.getActionManager().setSkill(new HomeTeleport());
	}
	...
	public static final void sendNormalTeleportSpell2(Player player, int level,
			double xp, WorldTile tile, int... runes) {
	...
	public static final void sendNormalTeleportSpell(Player player, int level, double xp, WorldTile tile, int... runes) {
		sendTeleportSpell(player, 513, -1, 91, 92 , 0, 0, tile, 10, true, MAGIC_TELEPORT, runes);
	}
	...
	public static void teleControlersCheck(Player player, WorldTile teleTile) {
		...
		else if (DuelControler.isAtDuelArena(teleTile))
	...
	public static boolean sendNormalTeleportSpell(Player player, boolean b,
			int eMOTE, int gFX, int i, WorldTile worldTile) {
