	...
	new BossRoom[] {
			...
			new BossRoom(new RoomEvent() {
				...
				public void openRoom(DungeonManager dungeon,
					...
					int id = getBossId(1, dungeon.getParty()
							.getDungeoneeringLevel() * 2, "Gluttonous behemoth");
			...
			new BossRoom(new RoomEvent() {
				...
				public void openRoom(DungeonManager dungeon,
					...
					int id = getBossId(1, level * 2, "To'Kash the Bloodchiller");
			...
			new BossRoom(new RoomEvent() {
				...
				public void openRoom(DungeonManager dungeon,
					...
					int level = dungeon.getParty().getDungeoneeringLevel();
					Player p = World.getPlayer(dungeon.getParty().getLeader());
					int id = getBossId(1, level * 2, "Astea Frostweb");
					// new AsteaFrostweb(id, reference, dungeon);
					// World.spawnNPC(id, new WorldTile(reference.getX(),
					// reference.getY(), 0), -1, true, true);
