...
public class Barrows extends Controler {
	...
	public static enum Brothers {
		 ...
		 * public void HandleBrother(String brother){ int io = Misc.random(3);
		 * switch(brother){ case "ahrim": switch(io){ case 0: break; case 1:
		 * break; case 2: break; case 3: break; } break;
		 * 
		 * 
		 * } }
		 */
