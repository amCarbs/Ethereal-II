...
public class Cooking extends Action {
	...
	public enum Cookables {
		 ...
		 * Shark
		 */
		RAW_SHARK(new Item(383, 1), 80, 200, 210, new Item(387, 1), new Item(
				385, 1), false, false),
		 ...
		 * Cavefish
		 */
		RAW_CAVEFISH(new Item(15264, 1), 88, 200, 214, new Item(15268, 1),
		 ...
		 * RockTail
		 */
		RAW_ROCKTAIL(new Item(15270, 1), 92, 200, 225, new Item(15274, 1),
	...
	public boolean process(Player player) {
		if (object.getId() == 2732
				&& !World.getRegion(object.getRegionId()).containsObject(
						object.getId(), object))
			return false;
