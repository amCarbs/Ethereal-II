...
public class HerbCleaning {
	...
	public static enum Herbs {
		GUAM(199, 2.5, 3, 249), MARRENTILL(201, 3.8, 5, 251), TARROMIN(203, 5,
				11, 253), HARRALANDER(205, 6.3, 20, 255), RANARR(207, 7.5, 25,
				257), TOADFLAX(3049, 8, 30, 2998), SPIRIT_WEED(12174, 7.8, 35,
				12172), IRIT(209, 8.8, 40, 259), WERGALI(14836, 9.5, 41, 14854), AVANTOE(
				211, 10, 48, 261), KWUARM(213, 11.3, 54, 263), SNAPDRAGON(3051,
				11.8, 59, 3000), CADANTINE(215, 12.5, 65, 265), LANTADYME(2485,
				13.1, 67, 2481), DWARF_WEED(217, 13.8, 70, 267), TORSTOL(219,
				15, 75, 269);
	...
	public static boolean clean(final Player player, Item item, final int slotId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				player.HERBS_CLEANED++;
				if (player.HERBS_CLEANED == 2500) {
					for (Player players : World.getPlayers()) {
						players.getPackets().sendGameMessage(
								"<img=8> <col=996600>"
								              + player.getDisplayName() + " cleaned 2,500 herbs!");
				}
				}
