...
public enum PickPocketableNPC {
	 ...
	 */
	MAN(new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 170 }, new byte[] { 1, 11, 21,
			31 }, new byte[] { 1, 1, 11, 21 }, 8.0, 4, 10,
			new Item(995, 25000), new Item(995, 15000), new Item(15753),
			new Item(16273), new Item(16339), new Item(16669), new Item(16691),
			new Item(16713), new Item(17341)),

	/**
	 * The regular farmer npcs.
	 */
	FARMER(new short[] { 7, 1757, 1758, 1760 }, new byte[] { 10, 20, 30, 40 },
			new byte[] { 1, 10, 20, 30 }, 14.5, 4, 10, new Item(995, 50000),
			new Item(5318, 1), new Item(995, 30000)),

	/**
	 * The female H.A.M. members.
	 */
	FEMALE_HAM(new short[] { 1715 }, new byte[] { 15, 25, 35, 45 }, new byte[] {
			1, 15, 25, 35 }, 18.5, 3, 10, new Item(995, 25000), new Item(590),
	...
	MALE_HAM(new short[] { 1714, 1716 }, new byte[] { 20, 30, 40, 50 },
			new byte[] { 1, 20, 30, 40 }, 22.5, 3, 20, new Item(995, 2500),
	...
	HAM_GUARD(new short[] { 1710, 1711, 1712 }, new byte[] { 20, 30, 40, 50 },
			new byte[] { 1, 20, 30, 40 }, 22.5, 3, 30, new Item(995, 40000),
			new Item(590), new Item(1621), new Item(1623), new Item(1625),
			new Item(1269), new Item(321), new Item(2138), new Item(4298),
			new Item(4300), new Item(4302), new Item(4304), new Item(4306),
			new Item(4308), new Item(4310), new Item(1267), new Item(1353),
	...
	WARRIOR(new short[] { 15, 18 }, new byte[] { 25, 35, 45, 55 }, new byte[] {
			1, 25, 35, 45 }, 26, 5, 20, new Item(995, 55000)),

	/**
	 * The rogues.
	 */
	ROGUE(new short[] { 187, 2267, 2268, 2269, 8122 }, new byte[] { 32, 42, 52,
			62 }, new byte[] { 1, 32, 42, 52 }, 35.5, 4, 20, new Item(995,
			45000), new Item(995, 20000), new Item(1993), new Item(556, 2),
	...
	CAVE_GOBLIN(new short[] { 5752, 5753, 5754, 5755, 5756, 5757, 5758, 5759,
			...
			36, 46, 56, 66 }, new byte[] { 1, 36, 46, 56 }, 40, 4, 10,
			new Item(995, 30000), new Item(590), new Item(4522),
			new Item(4544), new Item(596), new Item(1939), new Item(441, 4),
			new Item(441), new Item(10981)),

	/**
	 * The master farmer npcs.
	 */
	MASTER_FARMER(new short[] { 2234, 2235 }, new byte[] { 38, 48, 58, 68 },
			new byte[] { 1, 38, 48, 58 }, 43, 4, 30, new Item(5096), new Item(
	...
	MONKEY_KNIFE_FIGHTER(new short[] { 13195, 13212, 13213 }, new byte[] { 70,
			127, 127, 127 }, new byte[] { 1, 1, 1, 1 }, 150, 4, 10, new Item(
			995, 10000), new Item(995, 50000), new Item(869, 4), new Item(874,
			2), new Item(379), new Item(1331), new Item(1333), new Item(4587)),

	/**
	 * Gnomes.
	 */
	GNOME(new short[] { 66, 67, 68, 168, 169, 2249, 2250, 2251, 2371, 2649,
			2650, 6002, 6004 }, new byte[] { 75, 85, 95, 105 }, new byte[] { 1,
			75, 85, 95 }, 198.5, 4, 10, new Item(995, 30000), new Item(557),
	...
	HERO(new short[] { 21 }, new byte[] { 80, 90, 100, 110 }, new byte[] { 1,
			80, 90, 100 }, 275, 5, 40, new Item(995, 20000),
			new Item(995, 3000), new Item(560, 2), new Item(565),
	...
	DWARF_TRADER(new short[] { 2109, 2110, 2111, 2112, 2113, 2114, 2115, 2116,
			...
			556.5, 6, 10, new Item(995, 100000), new Item(995, 40000),
