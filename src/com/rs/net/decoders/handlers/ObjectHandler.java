...
public class ObjectHandler {
				...
				if (defs.getSizeX() > 1 || defs.getSizeY() > 1) {
					for (int xs = 0; xs < defs.getSizeX() + 1
						...
						for (int i = 0; i < FarmingSystem.farmingPatches.length; i++) {
							if (mapObject.getId() == FarmingSystem.farmingPatches[i]) {
								FarmingSystem.handleSeeds(player, i, mapObject);
							}
						}
		...
		player.setCoordsEvent(new CoordsEvent(tile, new Runnable() {
			...
			public void run() {
				...
				if (hunterNpc != null) {
					...
					player.getActionManager().setSkill(
							new Mining(object, RockDefinitions.Mineral_Deposit));
				else if (id == 10947)
					player.getActionManager().setSkill(
					...
					Runecrafting.craftEssence(player, 9075, 40, 8.7, true, 82,
							2);
			 else if (id == 583) {//interface 583
			       player.getInterfaceManager().sendInterface(583);
			      player.getPackets().sendIComponentText(583, 46, "Commands");
			      player.getPackets().sendIComponentText(583, 49, "<col=7CFC00>Rock crabs. ");
			      player.getPackets().sendIComponentText(583, 50, "<col=7CFC00>Hellhounds. ");
			      player.getPackets().sendIComponentText(583, 51, "<col=7CFC00>Revenants (Dangerous!!!!)");
			      player.getPackets().sendIComponentText(583, 52, "<col=7CFC00>Icefiends. ");
			      player.getPackets().sendIComponentText(583, 53, "<col=7CFC00>Zamorak. ");
			      player.getPackets().sendIComponentText(583, 54, "<col=7CFC00>Armadyl. ");
			      player.getPackets().sendIComponentText(583, 55, "<col=7CFC00>Bandos. ");
			      player.getPackets().sendIComponentText(583, 56, "<col=7CFC00>Saradomin. ");
			      player.getPackets().sendIComponentText(583, 57, "<col=7CFC00>Glacors. ");
			      player.getPackets().sendIComponentText(583, 58, "<col=7CFC00>Nomad. ");
			      player.getPackets().sendIComponentText(583, 70, "<col=7CFC00>Bork. ");
			      player.getPackets().sendIComponentText(583, 59, "<col=7CFC00>Corporeal beast. ");
			      player.getPackets().sendIComponentText(583, 60, "<col=c93030>Edgeville. ");
			      player.getPackets().sendIComponentText(583, 61, "<col=c93030>Easts. ");
			      player.getPackets().sendIComponentText(583, 62, "<col=c93030>Wests. ");
			      player.getPackets().sendIComponentText(583, 63, "<col=c93030>Mage bank. ");
			      player.getPackets().sendIComponentText(583, 64, "<col=8bf906>Runecrafting. ");
			      player.getPackets().sendIComponentText(583, 65, "<col=8bf906>Agility. ");
			      player.getPackets().sendIComponentText(583, 66, "<col=8bf906>Theiving. ");
			      player.getPackets().sendIComponentText(583, 67, "<col=8bf906>Hunter. ");
			      player.getPackets().sendIComponentText(583, 68, "<col=8bf906>Mining. ");
			      player.getPackets().sendIComponentText(583, 69, "<col=8bf906>Smithing. ");
			      player.getPackets().sendIComponentText(583, 71, "<col=8bf906>Fishing. ");
			      player.getPackets().sendIComponentText(583, 72, "<col=8bf906>Woodcutting. ");
			      player.getPackets().sendIComponentText(583, 79, "<col=8bf906>Farming. ");
			      player.getPackets().sendIComponentText(583, 73, "<col=e5ff00>Black Dragon. ");
			      player.getPackets().sendIComponentText(583, 76, "<col=e5ff00>Duel Arena. ");
			      player.getPackets().sendIComponentText(583, 74, "<col=e5ff00>Nex. ");
			      player.getPackets().sendIComponentText(583, 75, "<col=e5ff00>Tormented demons. ");
			      player.getPackets().sendIComponentText(583, 77, "<col=e5ff00>Slayer tower. ");
			      player.getPackets().sendIComponentText(583, 78, "<col=e5ff00>Dungoneering. ");
			 }
				else if (id == 2486)
					...
					player.setNextGraphics(new com.rs.game.Graphics(121));
				...
				else if (id == 13193) { // lunar altar
					if (player.getCombatDefinitions().getSpellBook() != 430) {
						player.getCombatDefinitions().setSpellBook(2);
						player.getPackets().sendGameMessage("You're now on the lunar spell book.");
					} else {
						player.getCombatDefinitions().setSpellBook(0);
						player.getPackets().sendGameMessage("You're now on the normal spell book.");
					}
				 ...
				 player.getPackets().sendGameMessage(
							"You need an thieving level of 15 to steal from this stall",
							true);
				...
				if (player.getSkills().getLevel(Skills.THIEVING) <= 0) {
				player.getPackets().sendGameMessage(
				"You need an thieving level of 15 to steal from this stall",
				true);
				return;
				...
				player.getPackets().sendGameMessage(
				"You need an thieving level of 35 to steal from this stall",
				true);
				return;
				} else if (player.getInventory().getFreeSlots() <= 0) {
				player.getPackets().sendGameMessage(
				...
				player.getPackets().sendGameMessage(
				"You need an thieving level of 45 to steal from this stall",
				true);
				return;
				} else if (player.getInventory().getFreeSlots() <= 0) {
				player.getPackets().sendGameMessage(
				...
				Thieving.handleStalls(player, object);
					...
					player.getInventory().addItem(995, 1330); 
					player.addStopDelay(3); 
					player.getSkills().addXp(17, 150);
					}

				
				else if (id == 411) { // zaros altar
					// recharge if needed
					player.setNextAnimation(new Animation(645));
					player.setNextGraphics(new com.rs.game.Graphics(1935));
				...
				else if (id == 29953 || id == 29954) { // zaros altar
				
			       
			 
					  player.getPackets()
                      .sendGameMessage(
                              "You abosorb the essence of the obelisk...",
                              true);
					  player.setNextAnimation(new Animation(645));
			                   player.getPackets()
			                            .sendGameMessage(
				...
				/*
				 * else if (id == 57437) player.getBank().openBank(); else if
				 * (id == 6084) player.getBank().openBank(); else if (id ==
				 * 22819) player.getBank().openBank(); else if (id == 25808)
			...
			Agility.walkGnomeRope(player);
					...
					Agility.walk2ndTreeBranch(player);
				else if (id == 43581)
					Agility.RunGnomeBoard(player);
				...
				} //the exp multiplyer that it gives. 
					...
					if (player.BandosKC < 40) {
						player.getPackets()
								.sendGameMessage(
										"You need a Bandos killcount of at least 40 to enter this room.");
						return;
					} 
					...
					case 26428:
						if (player.ZamorakKC < 40) {
							player.getPackets()
									.sendGameMessage(
											"You need a Zamorak killcount of at least 40 to enter this room.");
							return;
					...
					case 26427:
						if (player.SaradominKC < 40) {
							player.getPackets()
									.sendGameMessage(
											"You need a Saradomin killcount of at least 40 to enter this room.");
							return;
					...
					case 26426:
						if (player.ArmadylKC < 40) {
							player.getPackets()
									.sendGameMessage(
											"You need an Armadyl killcount of at least 40 to enter this room.");
							return;
					...
					case "arctic pine":
						if (objectDef.containsOption(0, "Cut down"))
							player.getActionManager().setSkill(
									new Woodcutting(object,
											TreeDefinitions.NORMAL));
						break;
				...
				Logger.log("ObjectHandler", "cliked 1 at object id : " + id
			...
			if (player.isAtDynamicRegion()
				...
				if (defs.getSizeX() > 1 || defs.getSizeY() > 1) {
					for (int xs = 0; xs < defs.getSizeX() + 1
						...
						for (int i = 0; i < FarmingSystem.farmingPatches.length; i++) {
							if (mapObject.getId() == FarmingSystem.farmingPatches[i]) {
								FarmingSystem.inspectPatch(player, mapObject);
							}
						}
						for (int ys = 0; ys < defs.getSizeY() + 1
								&& (mapObject == null || mapObject.getId() != id); ys++) {
			...
			public void run() {
				...
				if (id == 36786 || id == 42378 || id == 42377 || id == 42217
					...
					player.getBank().openBank();
						...
						.equalsIgnoreCase("small obelisk"))
					player.getSkills().restoreSkills();
				else if (object.getDefinitions().name
	...
	public static void handleExamine(final Player player, InputStream stream) {
		...
		Logger.log("ObjectHandler", "examined object: " + id + ", x: " + x
				+ ", y: " + y);
	}
		...
		player.setCoordsEvent(new CoordsEvent(tile, new Runnable() {
			...
			public void run() {
				...
				if (interfaceId == Inventory.INVENTORY_INTERFACE) { // inventory
					...
					//summoning altar
					else if (itemId == 18017 && object.getId() == 19864) {
						player.getSkills().addXp(Skills.SUMMONING, 70);
					    player.setNextAnimation(new Animation(883));
						player.getInventory().deleteItem(new Item(18017, 1));
						player.addStopDelay(1);
						
					}
					//cystal chest at home
					else if (itemId == 989 && object.getId() == 4130) {
	   player.setNextAnimation(new Animation(883));
						player.addStopDelay(3);
						player.getInventory().deleteItem(new Item(989, 1));
						player.getInventory().addItem(995, 5000000);
						player.getPackets().sendGameMessage("You loot the cystal chest.");
						
						player.CRYSTAL_CHESTS_OPENED++;
						
						player.getSkills().addXp(Skills.THIEVING, 250);
						if (player.CRYSTAL_CHESTS_OPENED == 500) {
							for (Player players : World.getPlayers()) {
								players.getPackets().sendGameMessage(
										"<img=8> <col=996600>"
										              + player.getDisplayName() + " has looted 500 Crystal chests!");
							}
						}
							for (Player players : World.getPlayers()) {
										if (players == null)
					...
					//more summoning
					else if (itemId == 12159 && object.getId() == 19864) {
						player.getSkills().addXp(Skills.SUMMONING, 85);
					    player.setNextAnimation(new Animation(883));
						player.getInventory().deleteItem(new Item(12159, 1));
						player.addStopDelay(1);
						
					}
					//more summoning
					else if (itemId == 12160 && object.getId() == 19864) {
						player.getSkills().addXp(Skills.SUMMONING, 100);
					    player.setNextAnimation(new Animation(883));
						player.getInventory().deleteItem(new Item(12160, 1));
						player.addStopDelay(1);
						
					}
					//more summoning
					else if (itemId == 12163 && object.getId() == 19864) {
						player.getSkills().addXp(Skills.SUMMONING, 125);
					    player.setNextAnimation(new Animation(883));
						player.getInventory().deleteItem(new Item(12163, 1));
						player.addStopDelay(1);
					...
					//pray altar
						...
						else if (itemId == 995 && object.getId() == 43096) {
						...
						Runecrafting.enterMindAltar(player);
							...
							&& object.getDefinitions().name.equals("Altar")) {
						player.getPackets().sendGameMessage(
								"You pray at the gods");
						player.getInventory().deleteItem(new Item(536, 1));
						player.getSkills().addXp(Skills.PRAYER, 650);
						player.getPackets().sendSound(2738, 0, 1);
						player.setNextAnimation(new Animation(896));
						...
						slashWeb(player, object);
							...
							|| objectDef.name.toLowerCase().contains("clay oven")
							|| id == 2732) {
