...
public class ButtonHandler {
	...
	public static void handleButtons(final Player player, InputStream stream,
		...
		if (interfaceId == 548 || interfaceId == 746 || interfaceId == 387) {
            ...
            switch (componentId) {
      case 49://rock crabs
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2323, 3794, 0));                                        
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Yaks!");	
            break;
      case 15://rock crabs
    	//  Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2673, 3709, 0));                                        
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Rock crabs!");	
            break;
      case 50:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2204,3253, 0));                                        
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Elf camp, "+player.getDisplayName());
          break;
      case 52:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2731,10220, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Ice Queens cave, "+player.getDisplayName());
          break;
      case 51: 
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3121,10132, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Revenants, "+player.getDisplayName());
          player.getControlerManager().startControler("Wilderness");
          break;
      case 53:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2882, 5309, 2));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to God Wars, "+player.getDisplayName());
          break;
      case 54:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2838, 5297, 2));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Armadyl Boss, "+player.getDisplayName());
          break;
      case 55:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2870, 5363, 2));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Bandos Boss, "+player.getDisplayName());
          break;
      case 56:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2901, 5264, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Saradomin Boss, "+player.getDisplayName());
          break;
      case 57:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(4185,5734, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Glacor cave, "+player.getDisplayName());
          break;
      case 58:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3360,5842, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Nomad, "+player.getDisplayName());
          break;
      case 70:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2749,3422, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Bork's lair, "+player.getDisplayName());
          break;
      case 59:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2966,4383, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Corporeal Beast, "+player.getDisplayName());
          break;
      case 60:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3092,3497, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Edgeville, "+player.getDisplayName());
          break;
      case 61:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3360,3658, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Easts, "+player.getDisplayName());
          player.getControlerManager().startControler("Wilderness");
          break;
      case 63:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2539,4712, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Magic Bank, "+player.getDisplayName());
          break;
      case 62:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3240,3611, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Wests, "+player.getDisplayName());
          player.getControlerManager().startControler("Wilderness");
          break;
      case 64:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2991, 9681, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Clan Wars Area, "+player.getDisplayName());
          break;
      case 69:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3743, 6427, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Dominion tower Area, "+player.getDisplayName());
          break;
      case 65:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3367, 3268, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Duel Arena, "+player.getDisplayName());
          break;
      case 66:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2661, 2648, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Pest Control, "+player.getDisplayName());
          break;
      case 67:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2339, 3803, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Skilling, "+player.getDisplayName());
          break;
      case 68:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3297, 3299, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Mining, "+player.getDisplayName());
          break;
      case 71:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2590,3423, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Fishing, "+player.getDisplayName());
          break;
      case 72:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2725, 3491, 0));                                  
          player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Woodcutting, "+player.getDisplayName());
          break;
      case 79:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2816,	3462, 0));
			player.sm("Click on the patches, and have seeds from Leprechaun.");
          break;
     /* case 73:
    	  Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2273,4681, 0));
    	  player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to the Queen Black Dragon, "+player.getDisplayName());
          break;*/
      case 73:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2273,4681, 0));
    	  player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to King Black Dragon, "+player.getDisplayName());
          break;
      case 75:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(2562,5739, 0));
    	  player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Tormented Demons, "+player.getDisplayName());
          break;
      case 74:
    	  player.getPackets().sendGameMessage(
                  "<col=40e0d0>Please talk to mr.ex at home, "+player.getDisplayName());
          break;
      case 77:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3426,3538, 0));
    	  player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Slayer tower, "+player.getDisplayName());
          break;
      case 78:
    	  Magic.sendNormalTeleportSpell2(player, 0, 0, new WorldTile(3298,9824, 0));
    	  player.getPackets().sendGameMessage(
                  "<col=40e0d0>Welcome to Dungeoneering "+player.getDisplayName());
          break;
            }
			...
			ClanChatManager
					.handleButtons(player, componentId, packetId, stream);
